...
import 'package:krishi_vishwa/end.dart';
...
class Sell extends StatefulWidget {
  int balance;
  int debt;
  Sell({this.balance, this.debt});
  @override
  _SellState createState() => _SellState(balance, debt);
}
...
class _SellState extends State<Sell> {
  ...
  int debt;
  String holder;
  _SellState(this.balance, this.debt);
  changeType() {
    setState(() {
  ...
  List<Data> croplist = [
    Data("assets/market.jpg", "Market", 30000, 4.5),
    Data("assets/retailer.jpg", "Retailer", 32000, 19),
    Data("assets/company.jpg", "Company", 35000, 20.0)
  ];
    ...
    return Scaffold(
      ...
      appBar: new AppBar(
        ...
        title: Row(
          ...
          children: <Widget>[
            Text('Select way to Sell Product:',
